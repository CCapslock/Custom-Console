...
namespace Painter
{
    internal class PaintInputController
    {
        ...
        public void Run(int Num, GameProfile gameProfile, int size, DrawHandler drawHandler)
        {
        ...
        public void Run(int Num, GameProfile gameProfile, int size, DrawHandler drawHandler, List<IObserver> observers)
        {
            _drawHandler = drawHandler;
            _num = Num;
            _gameProfile = gameProfile;
